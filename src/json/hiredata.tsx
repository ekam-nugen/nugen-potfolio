import { Users, ClipboardList, UserPlus, Briefcase, FileText, FileSignature, CheckSquare } from "lucide-react";
...
export const Hireservices = [
  ...
  },
  {
    ...
    subtitle: "Expert guidance to define your project scope and create a clear plan.",
  ...
  },
  {
    ...
    subtitle: "Deliver specific projects with defined deliverables and timelines.",
  ...
  },
  {
    ...
    subtitle: "Inject fresh expertise to ensure successful completion of ongoing projects.",
