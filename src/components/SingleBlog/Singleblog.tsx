...
export default function BlogPostPage() {
  ...
  return loading ? (
    ...
    <>
      ...
      <Head>
        <title>{post.title} - Blog | Nugen IT Services</title>
        <meta
          name="description"
          content={
            post.shortDescription ||
            "Discover insights and trends on technology, innovation, and more on the Nugen IT Services blog."
          }
        />
        <meta
          name="keywords"
          content={`Nugen IT services, blog, technology, trends, innovation, ${post.title}`}
        />
        <meta name="robots" content="index, follow" />
        <meta
          property="og:title"
          content={`${post.title} - Blog | Nugen IT Services`}
        />
        <meta
          property="og:description"
          content={
            post.shortDescription ||
            "Stay updated with the latest trends and insights in the tech world."
          }
        />
        <meta property="og:image" content={post.featuredImage || "/logo.png"} />
        <meta
          property="og:url"
          content={`https://nugeninfo.com/blog/${slugify(post.title)}`}
        />
      </Head>
